...
namespace demo_configuration
{
    internal class ConfigurationManager1 : ConfigurationManager
    {
        ...
        {
            get { return "DevDay 2017 Configuration demo"; }
        }
        ...
        protected override ImageSource Icon
        {
            get
            {
                return new BitmapImage(new Uri(@"pack://application:,,,/demo_configuration;component/Images/favicon.ico"));
            }
        }
